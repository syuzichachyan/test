...
export default class Modal extends React.Component {
  ...
  handleSubmit = e => {
    ...
    this.props.event.name ? this.state.onEditEvent(this.state.event) :
      ...
      >
        ...
        <div>
          <TextField
            ...
            onChange={(event, newValue) => this.setState({event: {...this.state.event, name: newValue}})}
          />
          <TextField
        ...
        <div>
          <RaisedButton
            className={this.props.event.name ? ' mr-3 my-3' : 'd-none mr-3 my-3'}
            label="Update"
            primary={true}
            type="submit"
          />
